...
public class Question_2_Staff_Details_BasicTest {

    @Test
    public void testAssertListDetailsBasic1(){
        ArrayList<Question_2_Staff_Details_Basic> staff_teacher_details = new ArrayList<>();
        Question_2_Staff_Details_Basic teacherDetails1 = new Question_2_Staff_Details_Basic(205074553,"Teacher","Olivia","Kearns", 'F');
        Question_2_Staff_Details_Basic teacherDetails2 = new Question_2_Staff_Details_Basic(195074545,"Teacher","Adam","Wessons", 'M');
    ...
    public void testSalaryMethodDetailsBasic3(){
        Question_2_Staff_Details_Basic question_2_staff_teacher_details = new Question_2_Staff_Details_Basic();


        Assert.assertEquals(question_2_staff_teacher_details.monthlySalary(),9000.0,1.0);
